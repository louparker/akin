...
export const en = {
  ...
  'post.full.notice': 'This conversation is now full.',
  ...
  'post.edit.error.windowClosed': 'Editing window has closed',
  'post.delete.confirm.title': 'Delete post?',
  'post.delete.confirm.body': 'Your post will be removed from the feed. This cannot be undone.',
  'post.delete.confirm.cta': 'Delete',
  'post.delete.confirm.cancel': 'Cancel',
  ...
  'comment.edit.error.windowClosed': 'Editing window has closed',
  'comment.delete.confirm.title': 'Delete comment?',
  'comment.delete.confirm.body':
    "Your comment will be removed. You'll keep your spot in the conversation.",
  'comment.delete.confirm.cta': 'Delete',
  'comment.delete.confirm.cancel': 'Cancel',
  ...
  'report.notes.placeholder': 'Tell us more (optional)…',
  'report.notes.label': 'Additional details',
  'report.error.rateLimit': "You've sent too many reports recently. Try again in an hour.",

  // ── Content filter — inline comment error ────────────────────────────────
  'error.CONTENT_FILTER_HIT.comment':
    "Your comment couldn't be posted. Please review the community guidelines.",
  ...
  // ── Moderator dashboard ───────────────────────────────────────────────────
  'mod.queue.title': 'Moderation queue',
  'mod.queue.empty': 'No open reports.',
  'mod.queue.depth': '{{n}} open',
  'mod.queue.filter.all': 'All',
  'mod.queue.filter.harassment': 'Harassment',
  'mod.queue.filter.hate': 'Hate',
  'mod.queue.filter.sexual': 'Sexual',
  'mod.queue.filter.threat': 'Threat',
  'mod.report.title': 'Report detail',
  ...
  'mod.report.targetHistory': 'Prior reports against this user: {{n}}',
  'mod.report.reporterHistory': 'Prior reports filed by this reporter: {{n}}',
  'mod.report.strikeCount': 'Strike count: {{n}}',
  'mod.action.dismiss': 'Dismiss',
  'mod.action.hide': 'Hide content',
  'mod.action.warn': 'Warn user',
  'mod.action.warnEffect.strike1': '→ Strike 1 of 3 (warning)',
  'mod.action.warnEffect.strike2': '→ Strike 2 of 3 (will auto-suspend 7 days)',
  'mod.action.warnEffect.strike3': '→ Strike 3 of 3 (will auto-ban permanently)',
  'mod.action.suspend': 'Suspend 7 days',
  'mod.action.ban': 'Ban permanently',
  'mod.action.csam': 'CSAM — zero tolerance',
  'mod.action.confirm.title': 'Are you sure?',
  'mod.action.confirm.reason.placeholder': 'Reason (required)',
  'mod.action.confirm.cta': 'Confirm',
  'mod.action.confirm.cancel': 'Cancel',
  'mod.action.success': 'Action taken.',
  'mod.action.error.noReason': 'Please add a reason.',
  'mod.audit.title': 'Audit log',
  'mod.audit.empty': 'No entries yet.',
  'settings.section.moderation': 'Moderation',
  'settings.mod.queue': 'Moderation queue',
