...
export const sv: TranslationDict = {
  ...
  'post.full.notice': 'Det här samtalet är nu fullt.',
  ...
  'settings.notifications.replies': 'Svar i konversationer',
  'settings.notifications.replies.body':
    'Få en diskret pushnotis när någon svarar i en konversation du är med i.',
  'settings.notifications.replies.hint': 'Slår på eller av pushnotiser för konversationssvar.',
  'settings.notifications.error.title': 'Notiser är inte aktiverade',
  'settings.notifications.error.permission':
    'Tillåt notiser i enhetens inställningar och försök igen.',
  'settings.notifications.error.generic': 'Kunde inte uppdatera notisinställningarna. Försök igen.',
  ...
  'settings.legal.yourData': 'Dina uppgifter',
  ...
  'post.menu.edit': 'Redigera inlägg',
  'post.menu.delete': 'Radera inlägg',
  'post.edit.save': 'Spara',
  'post.edit.cancel': 'Avbryt',
  'post.edit.error.windowClosed': 'Redigeringsfönstret har stängts',
  'post.delete.confirm.title': 'Radera inlägg?',
  'post.delete.confirm.body': 'Ditt inlägg tas bort från flödet. Detta kan inte ångras.',
  'post.delete.confirm.cta': 'Radera',
  'post.delete.confirm.cancel': 'Avbryt',
  ...
  'comment.sending': 'Skickar…',
  'comment.edit.save': 'Spara',
  'comment.edit.cancel': 'Avbryt',
  'comment.edit.error.windowClosed': 'Redigeringsfönstret har stängts',
  'comment.delete.confirm.title': 'Radera kommentar?',
  'comment.delete.confirm.body': 'Din kommentar tas bort. Du behåller din plats i samtalet.',
  'comment.delete.confirm.cta': 'Radera',
  'comment.delete.confirm.cancel': 'Avbryt',
  ...
  'report.notes.placeholder': 'Berätta mer (valfritt)…',
  'report.notes.label': 'Ytterligare information',
  'report.error.rateLimit': 'Du har skickat för många rapporter nyligen. Försök igen om en timme.',

  // ── Content filter — inline comment error ────────────────────────────────
  'error.CONTENT_FILTER_HIT.comment':
    'Din kommentar kunde inte publiceras. Läs gärna riktlinjerna.',
  'error.CONTACT_INFO_NOT_ALLOWED.comment':
    'Kommentarer får inte innehålla telefonnummer, e-post eller sociala handtag.',
  'error.contact_support': 'Kontakta support',

  // ── Moderator dashboard ───────────────────────────────────────────────────
  'mod.queue.title': 'Modereringskö',
  'mod.queue.empty': 'Inga öppna rapporter.',
  'mod.queue.depth': '{{n}} öppna',
  'mod.queue.filter.all': 'Alla',
  'mod.queue.filter.harassment': 'Trakasserier',
  'mod.queue.filter.hate': 'Hat',
  'mod.queue.filter.sexual': 'Sexuellt',
  'mod.queue.filter.threat': 'Hot',
  'mod.report.title': 'Rapportdetaljer',
  ...
  'mod.report.targetHistory': 'Tidigare rapporter mot den här användaren: {{n}}',
  'mod.report.reporterHistory': 'Tidigare rapporter från den här rapportören: {{n}}',
  'mod.report.strikeCount': 'Antal strikes: {{n}}',
  ...
  'mod.action.confirm.title': 'Är du säker?',
  'mod.action.confirm.reason.placeholder': 'Skäl (obligatoriskt)',
  'mod.action.confirm.cta': 'Bekräfta',
  'mod.action.confirm.cancel': 'Avbryt',
  'mod.action.success': 'Åtgärd vidtagen.',
  'mod.action.error.noReason': 'Ange ett skäl.',
  'mod.audit.title': 'Granskningslogg',
  'mod.audit.empty': 'Inga poster än.',
  'settings.section.moderation': 'Moderering',
  'settings.mod.queue': 'Modereringskö',
